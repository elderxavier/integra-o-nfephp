...
$diversos = array();
$diversos['name'] = 'Elder Xavier';
$diversos['email'] = 'eldersxavier@gmail.com';
$diversos['message'] = 'esta e uma mensagem de teste';

//$contact_form = new Contact_Form($_POST, $admin_email, $message_min_length);
$contact_form = new Contact_Form($diversos, $admin_email, $message_min_length);
